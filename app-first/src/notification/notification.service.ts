...
export class NotificationService {
    ...
    async createNotifiMsg(data:BaseNotifiDto){
        try{
            let id :String;
            console.log("create notifi")
            console.log(data)
            await this.notifiModel.deleteMany({targetUserId:data.targetUserId,sourceUserId:data.sourceUserId,type:data.type});
